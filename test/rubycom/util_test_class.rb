...
module UtilTestClass
  ...
  # A test_command which is only present in this class
  # @param [String] arg a test arg
  # @param [Integer] opt a test option
  def self.test_unique_command(arg,opt=1)
    [arg,opt]
  end
