...
class CommandsTest < Test::Unit::TestCase
  ...
  def test_get_top_level_commands
    ...
    result_command_list = Rubycom::Sources.get_top_level_commands(UtilTestModule)
  ...
  def test_get_top_level_commands_nil_base
    test_command_list = []
    result_command_list = Rubycom::Sources.get_top_level_commands(nil)
    assert_equal(test_command_list.length, result_command_list.length)
    test_command_list.each { |sym|
      assert_includes(result_command_list, sym)
    }
  ...
  def test_get_commands_nil_base
    test_command_list = []
    result_command_list = Rubycom::Sources.source_commands(nil)
    assert_equal(test_command_list.length, result_command_list.length)
    test_command_list.each { |sym|
      assert_includes(result_command_list, sym)
    }
  ...
  def test_get_top_level_commands_singleton_base
    test_command_list = []
    result_command_list = Rubycom::Sources.get_top_level_commands(UtilTestNoSingleton)
    assert_equal(test_command_list.length, result_command_list.length)
    test_command_list.each { |sym|
      assert_includes(result_command_list, sym)
    }
