...
module UtilTestModule
  ...
  def test_command_with_arg(test_arg)
    "test_arg=#{test_arg}"
  end
  ...
  def test_command_with_args(test_arg, another_test_arg)
  ...
  def test_command_with_options(test_arg, test_option='option_default')
  ...
  def test_command_all_options(test_arg='test_arg_default', test_option='test_option_default')
  ...
  def test_command_with_return(test_arg, test_option_int=1)
  ...
  def test_command_arg_timestamp(test_time)
    {test_time: test_time}
  end
  ...
  def test_command_arg_false(test_flag=false)
    test_flag
  end
